import std/sequtils, ../private/library, ../../allegro5, ../color, ../bitmap
...
proc text*(font: AllegroFont, color: allegro5.AllegroColor | color.AllegroColor, x, y: float, text: string, flags: AllegroFontFlag): void =
